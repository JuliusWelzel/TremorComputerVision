...
fig, ax = plt.subplots(10, 1, figsize=(20, 25), sharex=True)
ax[0].plot(times_mp, zscore(mp_world_amp_sum), color=colors_cvmodels["MPworld"], label="MP world", linewidth=2)
ax[0].set_ylim(-3, 3)
ax[0].set_ylabel("Amplitude (z-scored)")
ax[0].legend()
plot_normalized_spectrogram(mp_world_amp_sum, srate, ax[1], "MP world")
ax[2].plot(times_mp, zscore(mp_world_amp_sum_z), color=colors_cvmodels["MPworld_z"], label="MP world (with z axis)", linewidth=2)
ax[2].set_ylim(-3, 3)
ax[2].set_ylabel("Amplitude (z-scored)")
ax[2].legend()
plot_normalized_spectrogram(mp_world_amp_sum_z, srate, ax[3], "MP world (z-axis)")
ax[4].plot(times_mp, zscore(mp_norm_amp_sum), color=colors_cvmodels["MPnorm"], label="MP norm", linewidth=2)
ax[4].set_ylim(-3, 3)
ax[4].set_ylabel("Amplitude (z-scored)")
ax[4].legend()
plot_normalized_spectrogram(mp_norm_amp_sum, srate, ax[5], "MP norm")
ax[6].plot(times_mp, zscore(mp_norm_amp_sum_z), color=colors_cvmodels["MPnorm_z"], label="MP norm (with z axis)", linewidth=2)
ax[6].set_ylim(-3, 3)
ax[6].set_ylabel("Amplitude (z-scored)")
ax[6].legend()
plot_normalized_spectrogram(mp_norm_amp_sum_z, srate, ax[7], "MP norm (z-axis)")
ax[8].plot(times_mp, zscore(vi_amp_sum), color=colors_cvmodels["Apple_VI"], label="Vision", linewidth=2)
ax[8].set_ylim(-3, 3)
ax[8].set_ylabel("Amplitude (z-scored)")
ax[8].legend()
