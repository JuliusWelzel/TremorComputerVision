from src.config import (dir_tables, set_style) # import font size
...
# Load the data
file_path_new = dir_figdata.joinpath('human_peaks_table.csv')
...
sns.regplot(data_new[~idx_mp_omc],x="mocap_raw_freq",y="mp_raw_freq",ax=axes[0,0],label="MP norm vs OMC",color=color_mp)
...
sns.regplot(data_new[~idx_mp_imu],x="imu_raw_freq",y="mp_raw_freq",ax=axes[1,0],label="MP norm vs IMU",color=color_mp)
...
sns.regplot(data_new[~idx_apple_omc],x="mocap_raw_freq",y="vision_raw_freq",ax=axes[0,1],label="VI vs OMC",color=color_vi)
...
sns.regplot(data_new[~idx_apple_imu],x="imu_raw_freq",y="vision_raw_freq",ax=axes[1,1],label="VI vs IMU",color=color_vi)
...
stats_df.to_markdown(dir_tables.joinpath("table_frequencies_raw.md"))
...
sns.regplot(data_new,x="mocap_raw_freq",y="imu_raw_freq",ax=axes,label="OMC vs IMU",color="black")
...
fig.savefig(dir_figures.joinpath("IMUvsOMC.png"))
